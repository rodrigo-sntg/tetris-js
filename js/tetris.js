...
//         const [m,o] = [player._matrix, player._pos];
...
//         player._matrix.forEach((row,y) => {
//             row.forEach((value,x) => {
//                 if(value !== 0){
//                     arena[y + player._pos.y][x + player._pos.x] = value
//                 }
//             })    
//         })
//     }
...
//         player._matrix = createPiece(nextPiece);
//         nextPiece = pieces[pieces.length * Math.random() | 0];
//         drawNextPiece(createPiece(nextPiece))

//         player._pos.y = 0;
//         player._pos.x = (arena[0].length / 2 | 0) - (player._matrix[0].length / 2 | 0); // using bitwise comparator to floor number
...
//         const pos = player._pos.x;
//         let offset = 1;
//         rotate(player._matrix, dir);

//         while(collide(arena,player)){
//             player._pos.x += offset;
//             offset = -(offset + (offset > 0 ? 1 : -1));
//             if(offset > player._matrix[0].length){
//                 rotate(player._matrix, -dir);
//                 player._pos.x = pos;
//                 return;
//             }
...
//         document.getElementById('score').innerText = player._score;
//     }
...
//     const player = new Player({x: 0, y:0}, null, 0, new Position(0,0))
